...
<template>
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="m-0 text-primary"><strong>Expense & Income | Beban & Pendapatan</strong></h1>
                    <p><small>List pencatatan untuk transaksi pendapatan dan pengeluaran umum</small></p>
                </div>
                <div class="col-sm-6">
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <button @click="AddDataExpense" type="button" class="mb-2 btn btn-primary">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-pay">
                            ...
                            <Field name="walletId" as="select" class="form-control" :class="{ 'is-invalid': errors.userId }"
                                ...
                                <option value="" disabled>Select a Name</option>
                                <option v-for="wallet in wallets" :key="wallet.id" :value="wallet.id">{{ wallet.wallet_name
                                }}
                                </option>
