...
const createBill_s = (event) => {
    ...
    if (validateBill()) {
        if (!switchRange.value) {
            axios
                .post("/api/bill-single", form.value)
                .then((response) => {
            ...
            axios
                .post("/api/bill-singlerange", form.value)
                .then((response) => {
                    formatted_s.value = null;
                    clearform(errors.value, form.value);
                    if (response.data["exist"].length != 0) {
...
const createBillNonPeriod = (event) => {
    ...
    if (validateBillNon()) {
        axios
            .post("/api/bill-nonperiod", formNon.value)
            .then(() => {
...
const getPeriodic = () => {
    axios.get("/api/account/period").then((response) => {
...
const getSantriGroup = () => {
    ...
    axios
        .get("/api/group/santri/search-bill", {
            params: {
...
<template>
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <RouterLink to="/admin/billing/bill"
                                ...
                                <div class="row">
                                    <div class="col-md">
                                        <div class="form-group">
                                            <label>Santri</label>
                                            <div
                                                v-if="santris.length == 0"
                                                class="text-center m-2"
                                            >
                                                <div
                                                    class="spinner-grow spinner-grow-sm mr-1 text-primary"
                                                ></div>
                                                <div
                                                    class="spinner-grow spinner-grow-sm mr-1 text-primary"
                                                ></div>
                                            ...
                                            <VueMultiselect
                                                ...
                                                :options="santris"
                                                :class="{
                                                    'is-invalid': errors.santri,
                                                }"
                                                :multiple="true"
                                                :close-on-select="false"
                                                placeholder="Pilih Satu / Lebih ..."
                                                label="fullname"
                                                track-by="nis"
                                                :show-labels="false"
                                            >
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            >
                                                ...
                                                />
                                                <label
                                                    class="font-weight-lighter font-italic custom-control-label"
                                                    for="customSwitch6"
                                                    >Tunggal / Jamak</label
                                                >
                                            </div>
                                            ...
                                            <div v-else>
                                                ...
                                                >
                                                    <label
                                                        class="text-right text-primary font-weight-normal"
                                                        >{{ data.name }}</label
                                                    >
                                                    <input
                                                        :class="{
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr
                                                                v-else
                                                                v-for="santri in listSantriGroup"
                                                                :key="
                                                                    santri.nis
                                                                "
                                                            >
